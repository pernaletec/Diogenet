...
#observe({
#  print(head(nodes_reactive()))
#  print(head(edges_reactive()))
#})
...
output$downloadDataUI <- renderUI( {
  downloadButton("DownloadZip",  "Download", style = "width:100%;")
})
...
observe({
  ...
  nodesPath <- dataset$path[input$dataset_selection == dataset$name & dataset$type == "nodes"]
  edgesPath <- dataset$path[input$dataset_selection == dataset$name & dataset$type == "edges"]

  output$DownloadZip <- downloadHandler(
    filename = function() {"Data.zip"},
    content = function(con) {
      setwd(here::here())
      filesToSave <- c(paste0("./data/", nodesPath), paste0("./data/", edgesPath))
