...
centr_LOPL <- reactive({ CentralizationValues(graph_reactive_LOPL()) })
...
# Life of phytagoras Lamblichus Dataset
output$table_values_LOPL <- CentralityDataTable(values_LOPL())
# Custom Dataset
...
output$table_centr_LOPL <- CentralizationDataTable(centr_LOPL())
# Custom dataset
