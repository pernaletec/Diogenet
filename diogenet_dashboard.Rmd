...
h4("Appearence")
# Nodes/Label sizes
sliderInput(inputId = "label_size_global", label = "Label Size", min = 0.0, max = 5.0, value = c(1, 4),ticks = FALSE, step = 1)
sliderInput(inputId = "node_size_global", label = "Node Size", min = 10.0, max = 60.0, value = c(20, 40),ticks = FALSE, step = 5)
#hr()
...
output$labelUI_vnw <- renderUI({
  if (input$cmnt_vsl_pck == "visNetwork") {
    ...
    else sliderInput(inputId = "labelUI_vnw", label = "Label Size", min = 0.0, max = 5.0, value = c(1.0, 4.0),ticks = FALSE, step = 1)
  } 
})
...
output$nodeUI_vnw <- renderUI({
  if (input$cmnt_vsl_pck == "visNetwork") {
    ...
    else sliderInput(inputId = "nodeUI_vnw", label = "Node Size", min = 10, max = 60, value = c(20, 40),ticks = FALSE, step = 10)
  }
})
