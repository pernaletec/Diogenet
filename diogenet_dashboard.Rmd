...
output$labelUI_vnw <- renderUI({
  if (input$cmnt_vsl_pck == "visNetwork") {
    if (!is.null(input$labelUI_vnw)) sliderInput(inputId = "labelUI_vnw", label = "Label Size", min = 0.0, max = 5.0, value = c(input$labelUI_vnw[1], input$labelUI_vnw[2]),ticks = FALSE, step = 0.1)
    else sliderInput(inputId = "labelUI_vnw", label = "Label Size", min = 0.0, max = 5.0, value = c(1.0, 4.0),ticks = FALSE)
  } 
})

output$nodeUI_vnw <- renderUI({
  if (input$cmnt_vsl_pck == "visNetwork") {
    if (!is.null(input$nodeUI_vnw)) sliderInput(inputId = "nodeUI_vnw", label = "Node Size", min = 10, max = 60, value = c(input$nodeUI_vnw[1], input$nodeUI_vnw[2]),ticks = FALSE, step = 0.1)
    else sliderInput(inputId = "nodeUI_vnw", label = "Node Size", min = 10, max = 60, value = c(20, 40),ticks = FALSE)
  }
})

output$labelUI_igp <- renderUI({
  if (input$cmnt_vsl_pck == "igraph") {
    if (!is.null(input$labelUI_igp)) sliderInput(inputId = "labelUI_igp", label = "Label Size", min = 0.2, max = 2.0, value = c(input$labelUI_igp[1], input$labelUI_igp[2]),ticks = FALSE,step = 0.1)
    else sliderInput(inputId = "labelUI_igp", label = "Label Size", min = 0.2, max = 2.0, value = c(0.6, 1.5),ticks = FALSE)
  } 
})
...
output$nodeUI_igp <- renderUI({
  if (input$cmnt_vsl_pck == "igraph") {
    if (!is.null(input$nodeUI_igp)) sliderInput(inputId = "nodeUI_igp", label = "Node Size", min = 0.0, max = 20.0, value = c(input$nodeUI_igp[1], input$nodeUI_igp[2]),ticks = FALSE, step = 1)
    else sliderInput(inputId = "nodeUI_igp", label = "Node Size", min = 0.0, max = 20.0, value = c(3.0, 10.0),ticks = FALSE)
  }
})
