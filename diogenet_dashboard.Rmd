  ...
  if (input$cmnt_vsl_pck == "igraph") {
     ...
     output$cmnt_igp = renderPlot({
      ...
      withProgress(message = 'Creating graph', style = 'notification', value = 0.1, {
        ...
        #print(igraph::crossing(cluster, g_))
        #print(str(cluster))
        #print(c("black","red")[igraph::crossing(cluster, g_) + 1])
        #print(igraph::crossing(cluster, g_) + 1)
        
        if (input$cmnt_dtc_alg == "Cluster Edges Betweenness") {
        ...
        } else bridges_edge_col  = c("black","red")[igraph::crossing(cluster, g_) + 1]
