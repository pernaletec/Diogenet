...
output$table_values = DT::renderDT({return(values())}, 
                                   options = list(pageLength = 10,
                                                  scrollX = TRUE,
                                                  scrollY = TRUE,
                                                  autoWidth = TRUE,
                                                  columnDefs = list(list(width = '20px', targets = c(1, 2, 3, 4)),
                                                                    list(className = 'dt-center', targets = c(1, 2, 3, 4)))), 
                                   selection = c("none"))

output$table_centr = renderTable({return(centr())}, align = 'c', width = 'auto')
...
```{r}
  fillCol(h5("Centralization Scores"),
          ...
          DT::DTOutput(outputId = 'table_values'), flex = c(0.5,1,0.5,5))
```
