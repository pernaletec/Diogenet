...
degree_graph_local = reactive({
  if (input$plot_type == 'graph'){
    ...
    return(visNetworkOutput(outputId="local_network_degree"))    
  } 
  ...
  if (input$plot_type == 'chord'){
    
  } 
})

output$degree_local <- renderUI({
  degree_graph_local()
})

uiOutput(outputId = 'degree_local')
...
betweenness_graph_local = reactive({
  if (input$plot_type == 'graph'){
    ...
    return(visNetworkOutput(outputId="local_network_betweenness"))
  } 
...
output$betweenness_local <- renderUI({
  betweenness_graph_local()
})

uiOutput(outputId = 'betweenness_local')
...
closeness_graph_local = reactive({ 
  ...
  if (input$plot_type == 'graph'){
    ...
    return(visNetworkOutput(outputId="local_network_closeness"))    
  } 
...
output$closeness_local <- renderUI({
  closeness_graph_local()
})

uiOutput(outputId = 'closeness_local')
...
eigenvector_graph_local = reactive({
  ...
  if (input$plot_type == 'graph'){
    ...
    return(visNetworkOutput(outputId="local_network_centralities"))
  }
...
output$eigenvector_local <- renderUI({
  eigenvector_graph_local()
})

uiOutput(outputId = 'eigenvector_local')
