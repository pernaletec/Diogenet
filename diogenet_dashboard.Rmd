...
values = reactive({
    ...
    if (!is.null(input$node_sel_m) && !is.null(input$order_m)) {
      ...
      val =  data.frame(degree = degree(d[[1]]),
                         betweenness = as.numeric(format(betweenness(d[[1]], normalized =TRUE), digits = 3, nsmall = 3)),
...
centr = reactive({
  ...
  if (!is.null(input$node_sel_m) && !is.null(input$order_m)) {
    d = d()
    centr_ = data.frame(degree = as.numeric(format(centralization.degree(d[[1]])$centralization[1], digits = 3, nsmall = 3)),
                     betweenness = as.numeric(format(centralization.betweenness(d[[1]])$centralization[1], digits = 3, nsmall = 3)),
                     closeness = as.numeric(format(centralization.closeness(d[[1]])$centralization[1], digits = 3, nsmall = 3)),
                     eigenvector = as.numeric(format(centralization.evcent(d[[1]])$centralization[1], digits = 3, nsmall = 3))
                     )
