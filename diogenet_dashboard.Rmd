...
selectInput("plot_type", "Plot type:",
                c("Color gradient graph" = "graph",
                  "Heatmap chart" = "hetmap",
                  "Chord diagram" = "gear"))
...
output$local_network_centralities = renderVisNetwork({
  ...
  if (!is.null(input$node_sel_m) && !is.null(input$order_m)) {
    ...
    returnColor_evc = function(x) {substr(node_vir_col[col_index_evc(x)],1,nchar(node_vir_col[col_index_evc(x)])-2)}
  
    # Setting parameters straight in the data frame for visNetwork
    data$nodes$color.background = sapply(eigen_centrality(d[[1]])$vector, FUN = returnColor_evc)
    
    # print(col_index(eigen_centrality(d[[1]])$vector))
    # print(node_vir_col[col_index(eigen_centrality(d[[1]])$vector)])
    # print(node_vir_col[1.00])
    # 
    # print(length(eigen_centrality(d[[1]])$vector))
    # 
    # print(data$nodes$color.background)
    # print(eigen_centrality(d[[1]])$vector)
    ...
    data$nodes$color.border = sapply(eigen_centrality(d[[1]])$vector, FUN = returnColor_evc)
...
```{r}
  fillCol(h5("Graph metrics"),
          tableOutput(outputId = 'table_centr'),
          h5("Metrics by Phylosophers"),
