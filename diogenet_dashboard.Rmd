 ...
 font-family: verdana;font-size:14px;font-color:black;background-color: white;border: 1px solid #808074;')
  ...
  if (input$cmnt_vsl_pck == "igraph") {
     ...
     output$cmnt_igp = renderPlot({
      ...
      #Set label size
      if (is.null(input$labelUI_igp[1])) min_label = rescaled_value(0.6,1.5,4)
      else min_label = rescaled_value(0.6,1.5,input$labelUI_igp[1])
      
      if (is.null(input$labelUI_igp[2])) max_label = rescaled_value(0.6,1.5,6)
      else max_label = rescaled_value(0.6,1.5,input$labelUI_igp[2])
      ...
      # Set node size
      if (is.null(input$nodeUI_igp[1])) min_node = rescaled_value(3.0,10.0,4)
      else min_node = rescaled_value(3.0,10.0,input$nodeUI_igp[1])
      
      if (is.null(input$nodeUI_igp[2])) max_node = rescaled_value(3.0,10.0,6)
      else max_node = rescaled_value(3.0,10.0,input$nodeUI_igp[2])
