...
Local Network {data-navmenu="Local Network"}
===================================== 
...
Local Network Metrics {data-navmenu="Local Network"}
===================================== 
  ...
  if (!is.null(input$node_sel_m) && !is.null(input$order_m)) {
    ...
    centr = data.frame(centr_dgre = centralization.degree(d[[1]])$centralization[1],
      ...
      output$cent_degree = renderValueBox({
        valueBox(value = format(centr$centr_dgre, digits = 3, nsmall = 3),caption = "Centralization degree",icon = "fa-cloud-download-alt")  
      }) 
      
      output$cent_betwns = renderValueBox({
        valueBox(value = format(centr$centr_btwn, digits = 3, nsmall = 3),caption = "Centralization betweenness",icon = "fa-cloud-download-alt")  
      }) 
            
      output$cent_clsnes = renderValueBox({
        valueBox(value = format(centr$centr_clsn, digits = 3, nsmall = 3),caption = "Centralization closeness",icon = "fa-cloud-download-alt")  
      }) 
                  
      output$cent_evcent = renderValueBox({
        valueBox(value = format(centr$centr_egcn, digits = 3, nsmall = 3),caption = "Centralization eigenvector centralities",icon = "fa-cloud-download-alt")  
      }) 
      ...
      output$table_values = renderDT({
        return(values)
      }, options = list(paging = TRUE, scrollY = TRUE))
